...
const philosophyItems = [
    {
        year: "01",
        title: "Managing Complex & Siloed Networks",
        desc: "Unified architecture works across all vendors and technologies; vendor‑agnostic integration reduces silo complexity; intelligent correlation underpins relationships across environments; simplified operations deliver meaningful efficiencies.",
    ...
    {
        year: "02",
        title: "Reducing Operational Inefficiencies",
    ...
    {
        year: "03",
        title: "Ensuring Delivery Across Distributed Landscapes:",
        desc: "Cloud‑native architecture scales for any size; multi‑cloud support ensures native integration; intelligent distribution orchestrates context‑aware services; geographic flexibility adapts local requirements and regulations.",
    ...
    },
    {
        ...
        desc: "Contextual intelligence understands business context, not just technical metrics; continuous learning systems improve with experience; predictive capabilities detect issues before they impact services; explainable AI builds trust.",
                ...
                <div className="lg:col-span-1 lg:sticky lg:top-24">
                    <div className="max-w-prose">
                        <h2 className="text-4xl md:text-5xl font-bold text-white mb-2">
                            ...
                            <span className="text-purple-400">Real‑World Impact</span>
                        </h2>
                        <p className="text-(--color-text-dimmed) text-lg leading-relaxed">
                            Four fundamental approaches that set us apart from traditional IT automation companies.
                        </p>
                    </div>
                </div>
