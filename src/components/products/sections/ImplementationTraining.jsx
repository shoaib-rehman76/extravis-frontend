  ...
  return (
    <section className="py-20 border-t border-gray-800">
      ...
      <Wrapper>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-7xl mx-auto mb-16 px-4">
          {phases.map((phase, idx) => (
            <div key={idx} className="p-10 rounded-3xl bg-[#0A0118] border border-[#5c3ae480] flex flex-col items-start shadow-[0_10px_40px_-15px_rgba(0,0,0,0.5)]">
