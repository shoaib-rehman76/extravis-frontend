            ...
            >
                ...
                <div className="bg-[#0a0a0a]/90 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 md:p-12 relative overflow-hidden min-h-[600px] flex flex-col justify-between">
                    ...
                    <motion.div 
                        ...
                        className="absolute top-0 right-0 p-32 bg-blue-600/10 blur-[100px] rounded-full pointer-events-none"
                    ></motion.div>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <div>
                                    ...
                                    <h3 className="text-2xl md:text-3xl font-bold text-white leading-tight">{currentOffering.title}</h3>
                                </div>
                            </div>
