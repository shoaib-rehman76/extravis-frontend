        ...
        <div className="py-24 px-4 md:px-12 w-full overflow-hidden border-t border-gray-900/50">
            <div className="max-w-7xl mx-auto space-y-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div className="absolute -inset-4 bg-purple-600/20 blur-3xl rounded-full opacity-30 group-hover:opacity-50 transition duration-700"></div>
                        <img
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-900/40 border border-indigo-500/30 text-indigo-300 text-xs font-semibold tracking-wide uppercase mb-6">
                        ...
                        <h3 className="3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-indigo-400 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        className="bg-[#0f0f0f]/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-800 hover:border-indigo-500/50 transition-colors"
                    >
                ...
                >
                    ...
                    <div className="bg-[#0a0a0a]/90 backdrop-blur-xl border border-gray-800 rounded-3xl p-8 md:p-12 relative overflow-hidden min-h-[400px]">
                        ...
                        <motion.div
                            ...
                            className="absolute top-0 right-0 p-32 bg-purple-600/10 blur-[100px] rounded-full pointer-events-none"
                        ></motion.div>
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="flex items-center gap-4 mb-8">
                                            <div className="w-12 h-12 bg-indigo-600 rounded-xl flex items-center justify-center text-white shadow-lg shadow-indigo-900/20">
                                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.384-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
                                            </div>
                                            <div>
                                                <div className="text-purple-400 text-xs font-bold uppercase tracking-wider mb-1">Service {activeIndex + 1} of {aiOfferings.length}</div>
                                ...
                                <div className="flex gap-2">
                                    {aiOfferings.map((_, idx) => (
                                        <button
                                            ...
                                            className={`transition-all duration-300 rounded-full ${idx === activeIndex ? 'w-8 h-2 bg-indigo-500' : 'w-2 h-2 bg-gray-700 hover:bg-gray-600'}`}
                                        />
                                    ))}
                                </div>
                                <div className="flex gap-3">
                                    <button onClick={prevSlide} className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-white transition-all hover:scale-110 active:scale-95">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7"></path></svg>
                                    </button>
                                    <button onClick={nextSlide} className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-white transition-all hover:scale-110 active:scale-95">
